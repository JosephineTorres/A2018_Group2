<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AI.aspx.cs" Inherits="AI" %>
    ...
    <div class="container">
        <div class="content-container">
            ...
            <div class="movie-list-container">
                ...
                <p class="movie-list-title">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT * FROM [video] where Category='AI'"></asp:SqlDataSource>
                </p>
                </div>
                </div>
      </div>
