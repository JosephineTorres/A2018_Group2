...
<body style= "background-image:url(img/bg.jpg)">
    ...
    <div class="navbar">
        ...
        <asp:GridView ID="gvAdmin" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="Title"
            ...
            <Columns>
                    <asp:TemplateField HeaderText="Title">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtUsername" Text='<%# Eval("Title") %>' runat="server" />
                            </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="Category">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEmail" Text='<%# Eval("Category") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
