<%@ Page Language="C#" AutoEventWireup="true" CodeFile="discrete.aspx.cs" Inherits="discrete" %>
    ...
    <div class="container">
        <div class="content-container">
            <div class="featured-content"
                style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('img/discretebg.png'); background-repeat: no-repeat; background-size: cover;">
            ...
            <div class="movie-list-container">
                ...
                <p class="movie-list-title">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT * FROM [video] where Category='Discrete Math'"></asp:SqlDataSource>
                </p>
                </div>
                </div>
      </div>
