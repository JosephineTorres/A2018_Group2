<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cplus.aspx.cs" Inherits="Cplus" %>
    ...
    <div class="container">
        <div class="content-container">
            ...
            <div class="movie-list-container">
                ...
                <p class="movie-list-title">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:RegistrationConnectionString %>" SelectCommand="SELECT * FROM [video] where Category='C++'"></asp:SqlDataSource>
                </p>
                </div>
                </div>
      </div>
